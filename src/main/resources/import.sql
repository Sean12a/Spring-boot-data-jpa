/* Populate tables */
INSERT INTO clientes (nombre, apellido, email, create_at, foto) VALUES('Sebastian', 'Torres', 'sebastian@.com', '2023-08-01', '');
INSERT INTO clientes (nombre, apellido, email, create_at, foto) VALUES('Andres', 'Arias', 'andres.doe@gmail.com', '2023-08-02', '');
...
INSERT INTO users (username, password, enabled) VALUES('sean', '$2a$10$cVrG/6.bxI4TZU7dU3Q97uZPkzlE7UxLuAmQ0E5tK5sP7sb5kfhuy',1);
INSERT INTO users (username, password, enabled) VALUES('admin', '$2a$10$2yEnr4tCiRzkusOSN0BHeuhMwLO8.exB7MF5Z/aSLZZFiuaOuBHpO',1);

INSERT INTO 'authorities' (user_id, autothority) VALUES(1, 'ROLE_USER');
INSERT INTO 'authorities' (user_id, autothority) VALUES(2, 'ROLE_USER');
INSERT INTO 'authorities' (user_id, autothority) VALUES(2, 'ROLE_ADMIN');